    ...
    >
      <div className="container mx-auto flex h-screen flex-col items-center justify-center">
        <div className={"px-12 pt-16 drop-shadow-2xl"}>
          <p
            className="text-center text-7xl font-light md:text-8xl lg:text-9xl"
            style={{ textShadow: "-1px 2px 12px rgba(0,0,0,0.6)" }}
          >
            Steven Labelle
          </p>
          <p
            className="text-center text-3xl font-thin uppercase text-slate-400 lg:text-end lg:text-4xl"
